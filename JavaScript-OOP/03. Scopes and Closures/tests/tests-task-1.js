...
describe('Tests for Closures and Scopes in JavaScript', function () {
	...
	describe('"Task 1: Library"', function () {
		...
		describe('library.books.add', function () {
			...
			it('expect the book to be returned with generated ID(number greater than 1), ' +
				'when title, ISBN and author are valid', function () {
				var bookToAdd = {
		...
		describe('library.books.list', function () {
			...
			it('expect to return empty array, when category is provided and no book ' +
				'in that category is added', function () {
					var book = library.books.add({
						title: CONSTS.VALID.BOOK_TITLE,
